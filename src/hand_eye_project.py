...
def main():
    ...
    parser.add_argument('--folder_path', type=str, default='/data/holoassist',
                        help='Directory of untar data')
    parser.add_argument('--video_name', type=str, default='R087-27July-GoPro-Part2', help="Directory sequence")
